        ...
        <div className="hidden md:flex flex-1 max-w-md mx-4">
          <div className="relative w-full">
            ...
            <input
              type="text"
              readOnly
              placeholder="Search groceries, electronics, stores, or aisles..."
              className="w-full rounded-xl border border-slate-200 bg-slate-50/80 py-2 pl-10 pr-4 text-sm text-slate-900 placeholder-slate-400 focus:border-indigo-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all cursor-pointer"
            />
          </div>
        </div>
