      ...
      <div className="p-5 sm:p-6 pt-4 flex flex-col justify-between flex-1 gap-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            />
            {cheapestStoreName && (
              <span className="inline-flex items-center gap-1 text-xs font-semibold text-slate-700 bg-slate-50 border border-slate-200/90 px-2.5 py-1 rounded-xl truncate max-w-full">
                <span className="text-slate-500 font-normal text-[11px]">at</span>
